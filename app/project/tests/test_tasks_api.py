...
class PrivateTasksApiTests(TestCase):
    ...
    def test_retrieve_tasks(self):
        ...
        Task.objects.create(completed_by=self.user, title='second task', description='second description')
    ...
    def test_tasks_limited_to_user(self):
        ...
        Task.objects.create(completed_by=user2, title='Fruity')
    ...
    def test_delete_task(self):
        ...
        task = Task.objects.create(completed_by=self.user, title='Breakfast', description='Breakfast')
